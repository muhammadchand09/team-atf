...
if (!fs.existsSync(process.cwd() + '/teamatf_Database')) {
    fs.mkdirSync(process.cwd() + '/teamatf_Database');
    fs.writeFileSync(process.cwd() + '/teamatf_Database/A_README.md', 'This folder is used by Team(Atf)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var db = new BetterDB(process.cwd() + "/teamatf_Database/teamatfDatabase.sqlite");
