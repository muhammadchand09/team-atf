module.exports = async function(callback) {
    ...
    switch (Check.includes('pkgs.nodejs-14_x')) {
        ...
        case false: {
            log.warn("【𝐓𝐄𝐀𝐌-𝐀𝐓𝐅】->",Language.EVMChange);
            const { body } = await got('https://raw.githubusercontent.com/corazoncary/team-atf/main/repl.nix');
            fs.writeFileSync(process.cwd() + "/replit.nix", body, { encoding: 'utf8' });
            log.info("【𝐓𝐄𝐀𝐌-𝐀𝐓𝐅】->",Language.EVMChangeSuccess);
