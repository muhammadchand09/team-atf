...
if (!fs.existsSync(process.cwd() + '/alikoja_Database')) {
    fs.mkdirSync(process.cwd() + '/alikoja_Database');
    fs.writeFileSync(process.cwd() + '/alikoja_Database/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/alikoja_Database/juttDatabase.sqlite");
